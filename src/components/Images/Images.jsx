    ...
    <div>
      ...
      <FormGroup >
        <Typography
          ...
          sx={{
            fontSize: {
              xs: '1.25rem', // smaller font size on extra small screens
              sm: '1.5rem', // slightly larger font size starting from small screens
              md: '1.8rem', // default h2 size for medium screens and up
            },
          }}
        >
          Image Gallery
